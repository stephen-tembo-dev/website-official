                ...
                @foreach ($programs as $p)
                    <li>
                        <div class="collapsible-header"><i class="material-icons"><span
                                    class="material-icons-outlined">expand_more</span></i>{{ $p['program_code'] . ' - ' . $p['program_name'] }}
                        </div>
    ...
    <div class="row mb">
        ...
        <div id="test1" class="col m9 s12">
            <div @can('editor') class="edit-box" @endcan>
                <br>
                <p class="light-deca">
                    {{ $admission_infor->entry_requirements ?? 'No information available' }}
                </p>

                @can('editor')
                    <p class="right-align">
                        <a href="{{ route('admission-infor', 1) }}" class="btn-floating btn-small orange pulse"><i
        ...
        <div id="test2" class="col m9 s12">
            <div @can('editor') class="edit-box" @endcan>
                <br>
                <p class="light-deca">
                    {{ $admission_infor->how_to_apply ?? 'No information available' }}
                </p>
        ...
        <div id="test3" class="col m9 s12">
            <div @can('editor') class="edit-box" @endcan>
                <br>
                <p class="light-deca">
                    {{ $admission_infor->fees_and_scholarships ?? 'No information available' }}
                </p>
        ...
        <div id="test4" class="col m9 s12">
            <div @can('editor') class="edit-box" @endcan>
                <br>
                <p class="light-deca">
                    {{ $admission_infor->accomodation ?? 'No information available' }}
                </p>
