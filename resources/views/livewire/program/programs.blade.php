            ...
            <ul class="collapsible z-depth-0 white ">
                <li>
                    <div class="collapsible-header"><i class="material-icons"><span
                                class="material-icons-outlined">expand_more</span></i>Bachelors in Information
                        Technology</div>
                ...
                <li>
                    <div class="collapsible-header"><i class="material-icons"><span
                                class="material-icons-outlined">expand_more</span></i>Bachelors in Cyber Security</div>
                    <div class="collapsible-body">
                ...
                <li>
                    <div class="collapsible-header"><i class="material-icons"><span
                                class="material-icons-outlined">expand_more</span></i>Bachelors Degree in Software
                        Engineering</div>
                    <div class="collapsible-body">
                ...
                <li>
                    <div class="collapsible-header"><i class="material-icons"><span
                                class="material-icons-outlined">expand_more</span></i>Bachelors Degree in ICT with
                        Education</div>
                    <div class="collapsible-body">
