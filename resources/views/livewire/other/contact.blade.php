...
<div class="container">
        ...
        <h6 class="flow-text center wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;"><b>Get in touch</b></h6>
        ...
        <div class="container mt">
            ...
            <div class="row">
                <div style="padding: 20px; border-radius: 19px; margin-top: 20px; visibility: visible; animation-name: fadeIn;" class="col m10 s12 offset-m1 white z-depth-1 wow fadeIn">
                    ...
                    <form wire:submit.prevent="processemail">
                        ...
                        <button style="border-radius: 8px;" class="btn btn-small waves-effect waves-light black" type="submit" name="action">Send
