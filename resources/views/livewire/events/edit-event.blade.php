                        ...
                        <div>
                            <div class="row">
                                ...
                                <div class="input-field col m12 s12">
                                    ...
                                    <input type="date" wire:model="eventArr.date" placeholder="&nbsp;" required>
                                ...
                                <div class="input-field col s12">
                                    <textarea wire:model="eventArr.text" maxlength="2048" id="text" class="materialize-textarea" required>&nbsp;</textarea>
