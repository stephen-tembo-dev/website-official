                    ...
                    <div>
                        <div class="row">
                            <div class="input-field col m12 s12">
                                <input placeholder="Title" wire:model="marketingInfo.title" id="title" type="text" class="validate" maxlength="70">
                                @error('marketingInfo.title') <span class="red-text">{{ $message }}</span> @enderror
                            </div>

                            <div class="input-field col m12 s12">
                                <textarea placeholder="Message" wire:model="marketingInfo.text" id="message" class="materialize-textarea"></textarea>
                                @error('marketingInfo.text') <span class="red-text">{{ $message }}</span> @enderror
                            </div>

                            <div class="input-field col m12 s12">
                                <textarea placeholder="Video URL" wire:model="marketingInfo.video_url" id="url" class="materialize-textarea"></textarea>
