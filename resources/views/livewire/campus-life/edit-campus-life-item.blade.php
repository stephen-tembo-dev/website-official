<div>
    <div class="container">
        ...
        <h5 class="grey-text lighten-3 mt heading"><b>Campus Life: Edit {{ $item->title ?? 'Item' }}</b></h5>
                        ...
                        <div class="row mt-sm">
                            ...
                            <div class="col s12">
                                ...
                                <div class="file-field input-field">
                                    <div class="btn">
                                        <span>Image - 2:1</span>
                                        <input wire:model="itemArr.image_path" type="file">
                                    </div>
...
@script
    <script>
        $wire.on('campus-life-item-updated', () => {
            M.toast({
                html: 'updated successfully'
            })
        });

        $wire.on('campus-life-item-update-failed', () => {
            M.toast({
